# -*- coding: utf-8 -*-
"""
Created on Tue Aug 15 08:40:19 2023
...
for n in range(len(pollutants)):
    ...
    #Fill NaN values with 1 (fix this later)
    data = data.fillna(1)
    ...
    for time_instance in range(observed_values.shape[0]):
        ...
        if estimated_value is not None:
            ...
            scatter = plt.scatter(locations[:, 1], locations[:, 0], c=observed_values[time_instance], cmap='viridis', marker='o', label='Observed', edgecolors='k')
