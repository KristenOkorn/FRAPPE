# -*- coding: utf-8 -*-
"""
Created on Mon May 29 17:46:02 2023
...
for n in range(len(pollutants)):
    ...
    for k in range(len(pods)):
        ...
        #weights & biases
        savePath = os.path.join(subfolder_path,'{}_weights_bias_{}.csv'.format(pods[k],pollutants[n]))
        ...
        savePath = os.path.join(subfolder_path,'{}_sensitivity_{}.csv'.format(pods[k],pollutants[n]))
